...
extension LocationDetailViewController: CLLocationManagerDelegate {
		...
		switch status {
			...
			case .denied:
				showAlertToPrivacySettings(
					title: "User has not authorized location services",
					message: "Select 'Settings' below to open device settings and enable location services for this app.")
	...
	func showAlertToPrivacySettings(title: String, message: String) {
		...
		guard let settingsURL = URL(string: UIApplication.openSettingsURLString) else {
			print("Something went wrong getting the UIApplication.openSWettingsURLString")
			return
		}
